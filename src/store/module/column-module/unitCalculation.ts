...
let columns: Header [] = [
  new Header(
    ...
    "500",
    { typeSearch: TypeSearch.Text, columnSearch: "UnitCalculationName" , typeFilter: TypeFilter.Text, module: ModuleName.UnitCalculation, headerSearch: 'module.inventory.unitCalculationName'},
  ),
  new Header(
    ...
    "743",
    { typeSearch: TypeSearch.Text, columnSearch: "UnitCalculationDetail" , typeFilter: TypeFilter.Text, module: ModuleName.UnitCalculation, headerSearch: 'module.inventory.unitCalculationDetail',},
  ),
  new Header(
    "isActive",
